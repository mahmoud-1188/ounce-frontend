...
/// يومٌ ظاهري حين يُطفأ يوم العمل من الإعدادات: تمرّ به بوّابات «افتح
/// اليوم أولًا» دون أن يُختم به شيء (dayStamp يترك الحقلين فارغين).
const AUTO_WORKDAY = Object.freeze({ id: "__auto__", ref: "تلقائي", status: "open", auto: true, openedAt: null, openedBy: "النظام" });

const DEFAULT_SETTINGS = {
  workdayMode: "required",
  taxEnabled: true,
  taxRate: 0.15,
