...
// ⚠ سؤالٌ محفوظ (مُنشئ الاستعلام) تفضيلٌ شخصيٌّ بحت — نفس منزلة
// menuOrder/navLayout لا items/lots: لا يحتاج مصدر حقيقةٍ خادميًّا
// مشتركًا بين الأجهزة، فمحلي فقط بلا استثناء عمدي.
const SAVED_QUERIES_KEY = "ounce_saved_queries_v1";
...
const BRANCH_LINK_KEY = "ounce_branch_link_v1"; // private: {branchId, branchRef, branchName} resolved once from /b/<ref>
